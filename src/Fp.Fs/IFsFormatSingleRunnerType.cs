...
/// Provides base runner interface for <see cref="FormatSingleProcessor"/>.
/// </summary>
public interface IFsFormatSingleRunnerType<TData> where TData : Data
{
    /// <summary>
    /// Processes using segmented function.
    /// </summary>
    ...
    /// <param name="info">Processor info.</param>
    /// <typeparam name="T">Processor type.</typeparam>
    static abstract void Run<T>(IList<string>? args, FileProcessorInfo? info = null) where T : FormatSingleProcessor<TData>, new();
    ...
    /// <param name="extensions">Processor extensions.</param>
    /// <typeparam name="T">Processor type.</typeparam>
    static abstract void Run<T>(IList<string>? args, string name, string description, params string?[] extensions) where T : FormatSingleProcessor<TData>, new();
}
